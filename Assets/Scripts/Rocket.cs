...
public class Rocket : MonoBehaviour, IClickable
{
    [SerializeField]
    private SpriteRenderer tankFillPlaceHolder;

    private List<SpriteRenderer> tankFillSprites;

    [SerializeField]
    private TextMeshProUGUI fillAmountText;
    ...
    private void UpdateMinesInTank()
    {
    ...
    private void AdjustTankFillSprites()
    {
